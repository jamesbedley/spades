        ...
        var i = e("../helper-functions"),
            ...
            s = function() {
                ...
                return t.makeRenderFunc = function(a) {
                    ...
                    0 <= this.lastDealerIndex ? this.dealerIndex = (this.lastDealerIndex + 1) % e.length : this.dealerIndex = Math.floor(Math.random() * e.length) % e.length, this.nextPlayerToDealTo = (this.dealerIndex + 1) % e.length, this.renderEvent("pickdealer", function() {}, {
