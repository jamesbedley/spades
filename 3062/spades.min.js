! function r(s, o, l) {
    ...
    4: [function(e, t, a) {
        ...
        var S = function() {
            ...
            return t.setBoardHeight = function(e) {
                ...
                var o = "/shared/images/cards/normalcards-" + s + "x.css";
                $("#csscards").attr("href") !== o && ($("#csscards").remove(), $("<link>", {
                    rel: "stylesheet",
                    id: "csscards",
                    href: "/shared/images/cards/normalcards-" + s + "x.css"
                }).appendTo("head"))
    ...
    19: [function(e, t, a) {
        ...
        if (! function() {
            ...
            }(), "debug" === x.log && (p.level = "debug"), (location.hostname || "").match(/translat/) || x.translatecheck ? ($("#play-page").remove(), m.badDomain(), $("#board").append($("<div>", {
                id: "translate-proxy"
            }).html('We do not support playing the game on translation websites. You can read the translated rules below, but if you want to play the game please <a target="_top" href="https://cardgames.io/' + slug + "/?fromproxy=" + location.hostname + '">CLICK HERE</a> to open the real CardGames.io website.'))) : location.hostname && "cardgames.io" !== location.hostname && "dev.cardgames.io" !== location.hostname && !window.APP_MODE && (m.badDomain(), location.href = "https://cardgames.io"), x.fromproxy) {
